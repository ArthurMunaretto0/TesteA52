...
insert into funcionarios (id, nome, sobrenome) values (3, 'João', 'Silva');
...
insert into projetos (projetoid, nome_projeto, responsavelid) values (103, 'Gestão do veiculo', 3);
